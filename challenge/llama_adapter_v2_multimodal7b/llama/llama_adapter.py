...
class LLaMA_adapter(nn.Module):
    ...
    def __init__(self, llama_ckpt_dir, llama_tokenizer,
        ...
        w_bias = (phase == "finetune" or phase=="after_fintune")
    ...
    def llama_parallel(self, assist_device):
        self.llama = self.llama.to(assist_device)
        # self.adapter_query = self.adapter_query.half().to(assist_device)
        # self.tokenizer = self.tokenizer.to(assist_device)
