...
class VAD(MVXTwoStageDetector):
    ...
    def simple_test_pts(
        ...
        **kwargs
        ...
        outs = self.pts_bbox_head(x, img_metas, prev_bev=prev_bev,
                                  ego_his_trajs=ego_his_trajs, ego_lcf_feat=ego_lcf_feat, **kwargs)
    ...
    def load_model(self, pretrained, map_location='cpu'):
        """Load checkpoint to model."""
        from mmcv.runner import load_checkpoint
        load_checkpoint(self, pretrained, map_location=map_location)
        # import time
        # print('Load VAD checkpoint:', pretrained)
        # time.sleep(3)
