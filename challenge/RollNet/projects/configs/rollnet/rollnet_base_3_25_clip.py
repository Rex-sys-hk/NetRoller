...
lr_scale = 1.0
use_ds = False # wether use deepspeed. Not work
roller_num = 8
roller_out_dim = 4*_dim_
rolling_query_names = ['bev_emb'] # ['map', 'bev', 'bev_emb', 'motion', 'ego_motion', 'detr']
roller_type = "RollerTF" # RollerIter, RollerTF, RollerBias
use_layer_embedding = False
use_attn_ratio = False
tf_layer_num = 32
all_iter = True # unused, deprecated
max_hidden_states_iters = 1 # 192
