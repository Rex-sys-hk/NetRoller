...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help='results_nusc.pkl file path')
...
def main():
    ...
    if args.results_nusc:
        outputs = mmcv.load(args.results_nusc)
        print(outputs.keys())
    ...
    if rank == 0:
        ...
        if hasattr(model, 'show_time'):
            model.show_time(kwargs['jsonfile_prefix'])
            # model.show_time()
